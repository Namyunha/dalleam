...
export default function NavBar({ userName }: { userName?: string }) {
  return (
    <div className="w-100vw h-56pxr md:h-60pxr border-b-2 border-black bg-orange-600 text-center text-orange-50 font-semibold text-sm md:text-base">
